...
@app.get("/v2/", include_in_schema=False)
def index():
    """Serve v2 Linear/Arc-style UI as the default. /v2 kept as alias."""
...
@app.get("/v1/", include_in_schema=False)
def index_v1():
    """Serve legacy single-page UI at /v1 for operators needing the old view."""
